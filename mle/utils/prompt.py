PMPT_DATASET_INFER = """
    ...
    - Each entry in the list should be a string containing the dataset name followed directly by a comma and
     the summary.
...
PMPT_TASK_DESC_GEN = f"""
    ...
    ## Example Output (in strict JSON format):
